...
create function drop_prepared_statement(_statements text[])
...
create function print_table_as_json(in _table_schema text, in _table_name text)
returns void
 language plpgsql
AS $function$
declare
...
create function print_query_as_json(in _prepared_statement_name text)
returns void
 language plpgsql
as $function$
declare
